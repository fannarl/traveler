...
# Next you should let the user input size many values to a list. Next the program should print the average of all the values in the list. 
...
print('{0} is the average.'.format(total//size))